...
const translations = {
  en: {
    ...
    "casework.eyebrow": "Business casework",
    "casework.title": "Strategy, finance, and AI thinking applied to real business problems.",
    "casework.text": "Selected work from MBA projects and internship assignments, focused on market entry, stakeholder problems, financial planning, and practical implementation.",
  ...
  fr: {
    ...
    "casework.eyebrow": "Cas business",
    "casework.title": "Stratégie, finance et IA appliquées à des problèmes business concrets.",
    "casework.text": "Sélection de travaux issus de projets MBA et de missions de stage, autour de l'entrée marché, des problèmes stakeholders, de la planification financière et de l'implémentation.",
